...
(
 ...
 shipping_mode varchar(15) NOT NULL,
...
select 100+row_number() over(), country, city, state, postal_code from (select distinct country, city, state, postal_code from public.orders ) a;
--data quality check
